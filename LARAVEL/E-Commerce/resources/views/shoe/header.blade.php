                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex">
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center "><a class="btn btn-outline-light mt-3 bi-cart-fill me-1" href=""><span class="badge bg-dark text-dark ms-1 rounded-pill text-white">0</span></a></div>
                        </div>
                    </form>
                </div>
            </div>
