        ...
        <form class="mx-auto mb-0 mt-8 max-w-md space-y-4" method="POST" action="{{ route('login') }}">
            ...
            <div class="flex items-center justify-between">
                <p class="text-sm text-gray-600">
                    No account yet?
                    <a href="{{ route('register') }}" class="underline hover:text-purple-600">Create one</a>
                </p>
            ...
            <button
                class="w-full rounded-lg bg-purple-600 px-5 py-3 text-sm font-medium text-white hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-opacity-50"
                type="submit"
            >
                {{ __('Sign In') }}
            </button>
